...
def score(nice,mean,name):
    # score funtion is being passed the values stored within the 3 variables
...
def win(nice,mean,name):
    ...
    print("\nNice job {}, you win! \nEveryone loves you and you've \nmade everyone's day!".format(name))
    # call again function and pass in our varables
    again(nice,mean,name)


def lose(nice,mean,name):
    #Substitue the {} wildcards with our variable value
    print("\nAhhhh too bad, game over! \n{}, you made lots of enemies \nyou should try being nicer!".format(name))
